...
INSERT INTO `pagamento_com_boleto` VALUES (NULL,'2017-10-19 23:00:00',2);
...
CREATE TABLE `produto_categoria` (
  `produtos_produto_id` int(11) NOT NULL,
  `categorias_categoria_id` int(11) NOT NULL,
  KEY `FKmjb37yv5sr1y3412bifcv7efm` (`categorias_categoria_id`),
  KEY `FK3urwajik3gidsng87j3h5n3xl` (`produtos_produto_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `telefone` (
  ...
  KEY `FKnfj8eje0sej4a8cvwvfo6njtb` (`cliente_cliente_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-08-27 13:40:50
